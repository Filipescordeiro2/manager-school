...
public class StudentService {
    ...
    public Optional<StudentResponse> findByCpfAndInstitutionId(String cpf, UUID institutionId) {
        var students = studentRepository.findByCpfAndInstitutionId(cpf, institutionId);
        return students.map(this::convertToStudentResponse);
    }
